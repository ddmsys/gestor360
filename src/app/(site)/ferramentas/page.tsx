        ...
        <div className="mx-auto grid max-w-[var(--container-xl)] items-center gap-10 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-[minmax(0,1fr)_360px] lg:py-20">
          <div>
            <div className="mb-6 flex flex-wrap items-center gap-3">
              ...
              <span className="h-8 w-px bg-[var(--color-border)]" aria-hidden="true" />
              <span className="text-sm font-semibold uppercase tracking-[0.12em] text-[var(--color-text-muted)]">
            ...
            {capInfo ? (
              <>
                ...
                <h1 className="max-w-3xl font-display text-[clamp(2.5rem,7vw,5.5rem)] font-black leading-[0.95] text-[var(--color-text-title)]">
                  {capInfo.titulo}
                </h1>
                <p className="mt-5 max-w-xl text-base leading-[var(--leading-relaxed)] text-[var(--color-text-body)] sm:text-lg">
                  {capInfo.ferramentas}
                </p>
              </>
            ) : (
              <>
                <h1 className="max-w-3xl font-display text-[clamp(2.75rem,8vw,6rem)] font-black leading-[0.95] text-[var(--color-text-title)]">
                  31 ferramentas para colocar o Gestor360 em prática
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-[var(--leading-relaxed)] text-[var(--color-text-body)] sm:text-lg">
            ...
            <div className="mt-8 grid max-w-xl grid-cols-3 border-y border-[var(--color-border)] text-center sm:text-left">
              <div className="py-4 pr-3">
                <p className="font-display text-2xl font-black text-[var(--color-text-title)]">31</p>
                <p className="text-xs font-medium text-[var(--color-text-muted)]">ferramentas</p>
              </div>
              <div className="border-x border-[var(--color-border)] px-3 py-4">
                <p className="font-display text-2xl font-black text-[var(--color-text-title)]">10</p>
                <p className="text-xs font-medium text-[var(--color-text-muted)]">capítulos</p>
              </div>
              <div className="py-4 pl-3">
                <p className="font-display text-2xl font-black text-[var(--color-text-title)]">1</p>
                <p className="text-xs font-medium text-[var(--color-text-muted)]">método</p>
              </div>
            </div>
          </div>
